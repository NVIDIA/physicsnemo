...
.. dropdown:: Model Implementation
   ...
   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/ViT.py
...
.. dropdown:: Patch Embedding Implementations
   ...
   .. tab-set::
       ...
       .. tab-item:: 2D
           ...
           .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/PatchEmbed2D.py
              :caption: Convolutional Patch Embedding in 2D
              :language: python

       .. tab-item:: 3D

           .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/PatchEmbed3D.py
              :caption: Convolutional Patch Embedding in 3D
              :language: python

.. dropdown:: Transformer Block

   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/TransformerBlock.py
      :caption: Transformer Block
      :language: python

.. dropdown:: MLP

   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/MLP.py
      :caption: Simple Multi-layer Perceptron
      :language: python

.. dropdown:: Multi-head Attention

   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/model/MultiHeadAttention.py
...
.. dropdown:: How to measure model performance
   ...
   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/utils/measure_perf.py
...
.. dropdown:: Measuring memory usage
   ...
   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/utils/measure_memory.py
...
.. dropdown:: End to End Benchmarking
   ...
   .. literalinclude:: ../../../examples/minimal/ShardTensorExamples/5_vit_training_loop/utils/benchmark.py
...
.. note:: 
    Don't want to copy+paste?  Find the full training script and all worker functions, configurable by domain size and ddp size, on the `physicsnemo` `GitHub Examples <https://github.com/NVIDIA/physicsnemo/tree/main/examples/minimal/ShardTensorExamples/5_vit_training_loop/>`_
