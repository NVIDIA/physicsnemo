...
def test_repr_simple_case():
    ...
    expected = r"""Mesh[2, 3](n_points=4842, n_cells=19147)
    point_data : {}
    cell_data  : {noise: ()}
    global_data: {}"""
...
def test_repr_many_fields():
    ...
    expected = r"""Mesh[2, 3](n_points=100, n_cells=50)
    point_data : {
        pressure   : (),
        stress     : (3, 3),
        temperature: (),
...
def test_repr_complex_nested():
    ...
    expected = r"""Mesh[1, 2](n_points=100, n_cells=50)
...
def test_repr_empty_mesh():
    ...
    expected = r"""Mesh[2, 3](n_points=10, n_cells=5)
    point_data : {}
    cell_data  : {}
    global_data: {}"""
...
def test_repr_with_device():
    ...
    expected = r"""Mesh[2, 3](n_points=100, n_cells=50, device=cpu)
    point_data : {}
...
def test_repr_with_cuda_device():
    ...
    expected = r"""Mesh[2, 3](n_points=100, n_cells=50, device=cuda:0)
    point_data : {}
    cell_data  : {pressure: (), velocity: (3,)}
    global_data: {}"""
