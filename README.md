...
[**physicsnemo.mesh**](https://docs.nvidia.com/physicsnemo/latest/user-guide/mesh.html) | A GPU-accelerated mesh module for physics-AI workflows that provides mesh processing routines and high-performance mesh data structure that are particularly well-suited for ML workflows.|
