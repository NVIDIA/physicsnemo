...
<!-- markdownlint-disable -->
| Module | Visual overview | Learn more |
|---|---|---|
| **PhysicsNeMo Curator** : Prepare, filter and transform raw simulation datasets into ML ready data structures for optimal I/O and training. | ![PhysicsNeMo Curator data preparation pipeline](/docs/img/data_curation_icon.png)(https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#offline-data-curation-with-physicsnemo-curator)|[Explore data curation →](https://nvidia.github.io/physicsnemo-curator/) |
| **`physicsnemo.datapipes`**: Optimized and scalable built-in data pipelines fine-tuned to handle engineering and scientific data structures like point clouds, meshes, etc. from HDF5, Zarr and PhysicsNeMo mesh into training. | [![PhysicsNeMo Datapipes streaming scientific data into PyTorch](docs/assets/modules/datapipes.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#data-loading-and-preprocessing-with-physicsnemo-datapipes) | [Explore data loading →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#data-loading-and-preprocessing-with-physicsnemo-datapipes) |
| **`physicsnemo.mesh`**: A GPU-accelerated mesh module for physics-AI workflows that provides mesh processing routines and high-performance mesh data structure that are particularly well-suited for ML workflows. | [![PhysicsNeMo Mesh geometry and field processing](/docs/img/physicsnemo_mesh_icon.png)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#mesh-processing-with-physicsnemo-mesh) | [Explore mesh processing →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#mesh-processing-with-physicsnemo-mesh) |
| **`physicsnemo.nn`**: Build custom models with optimized SciML layers and operators. | [![PhysicsNeMo optimized neural network layers](docs/assets/modules/nn.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#leverage-optimized-sciml-operators-and-layers) | [Explore layers and operators →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#leverage-optimized-sciml-operators-and-layers) |
| **`physicsnemo.models`**:  A collection of optimized, customizable, and easy-to-use families of model architectures such as Transofrmers, Neural Operators, Graph Neural Networks and diffusion backbones. | [![PhysicsNeMo scientific machine learning model architectures](docs/assets/modules/models.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#sciml-model-zoo) |[Explore model architectures →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#sciml-model-zoo) |
| **`physicsnemo.distributed`**: Scale training and shard spatial tensors that exceed one GPU. | [![PhysicsNeMo distributed training across GPUs](docs/assets/modules/distributed.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#domain-parallelism-for-large-spatial-tensors) | [Explore distributed training →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#domain-parallelism-for-large-spatial-tensors) |
| **`physicsnemo.diffusion`**:  Train and sample diffusion or flow-matching models.  | [![PhysicsNeMo scientific diffusion modeling pipeline](docs/assets/modules/diffusion.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#train-and-sample-diffusion-models-with-physicsnemo-diffusion) | [Explore diffusion modeling →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#train-and-sample-diffusion-models-with-physicsnemo-diffusion) |
| **`physicsnemo.sym`**: Add symbolic PDE residuals and physics-informed losses with automatic spatial derivatives into your training loop.  | [![PhysicsNeMo symbolic PDE residual losses](docs/assets/modules/sym.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#incorporate-physics-informed-losses-in-your-pytorch-training-loop) | | [Explore physics-informed training →](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#incorporate-physics-informed-losses-in-your-pytorch-training-loop) |
| **`physicsnemo.active_learning`**: Iteratively train, query informative samples, obtain labels, and measure model performance while minimizing expensive simulation data. | [![PhysicsNeMo active learning workflow](docs/assets/modules/active-learning.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/active_learning.html) | [Explore active learning →](https://docs.nvidia.com/physicsnemo/latest/user-guide/active_learning.html) |
| **Guardrails — Experimental**: Validate inputs and predictions using geometry and embedded OOD detection, PDE residuals, and ensemble uncertainty. | [![PhysicsNeMo model validation and guardrails workflow](docs/assets/modules/guardrails.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/guardrails.html) | [Explore model guardrails →](https://docs.nvidia.com/physicsnemo/latest/user-guide/guardrails.html) |
<!-- markdownlint-enable -->
