...
|---|---|---|---|
| **PhysicsNeMo Curator** | [![PhysicsNeMo Curator data preparation pipeline](docs/assets/modules/curator.webp)](https://docs.nvidia.com/physicsnemo/latest/user-guide/physicsnemo_for_pytorch.html#offline-data-curation-with-physicsnemo-curator) | Prepare, filter and transform raw simulation datasets into ML ready data structures for optimal I/O and training. | [Explore data curation →](https://nvidia.github.io/physicsnemo-curator/) |
