...
from physicsnemo.nn.module.hpx.tokenizer import HEALPixPatchTokenizer, HEALPixPatchDetokenizer
...
def get_detokenizer(
    ...
    out_channels: int,
    hidden_size: int,
    detokenizer: Literal["proj_reshape_2d", "hpx_patch_detokenizer"] = "proj_reshape_2d",
