...
The functions in this namespace accept a reference
:class:`~physicsnemo.mesh.Mesh`. Tensor-only functionals remain in
:mod:`physicsnemo.nn.functional.geometry.deform`.
"""
