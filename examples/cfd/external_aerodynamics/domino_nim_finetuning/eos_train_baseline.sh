...
#SBATCH -J coreai_modulus_cae-modulus:train_baseline
#SBATCH -t 02:58:00
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --dependency=singleton
#SBATCH -o ./sbatch_logs_baseline/multi/%x_%j.out
#SBATCH -e ./sbatch_logs_baseline/multi/%x_%j.err
...
# train the model
RUN_CMD="python -u src/train_baseline.py exp_tag=21 model.model_type=combined model.surface_points_sample=54000 model.volume_points_sample=54000 model.loss_function.loss_type=mse model.activation=relu model.surface_sampling_algorithm=area_weighted"
