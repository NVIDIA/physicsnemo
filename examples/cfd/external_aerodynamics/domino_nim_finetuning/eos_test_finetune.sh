...
#SBATCH -J coreai_modulus_cae-modulus:test_finetune_500
#SBATCH -t 00:15:00
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --dependency=singleton
#SBATCH -o ./sbatch_logs_finetune_test/multi/%x_%j.out
#SBATCH -e ./sbatch_logs_finetune_test/multi/%x_%j.err
...
# train the model
RUN_CMD="python -u src/test.py exp_tag=30 model.model_type=combined model.activation=relu eval.checkpoint_name=DoMINO.0.${CHECKPOINT_EPOCH}.pt eval.save_path=/lustre/rranade/modulus_dev/data/drivaer_data_finetune_test_predicted_${CHECKPOINT_EPOCH}"
