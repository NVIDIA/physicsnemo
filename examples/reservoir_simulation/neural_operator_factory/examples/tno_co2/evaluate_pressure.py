...
def dnorm_dP(dP):
    """Denormalize pressure predictions from normalized to physical units."""
...
def r_dnorm_dP(dP):
    """Reverse-denormalize pressure targets from physical to normalized units."""
...
def mean_relative_error(y_pred, y_true):
    """Compute mean relative error between predictions and targets."""
